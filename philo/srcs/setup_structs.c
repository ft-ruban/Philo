...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/30 15:37:29 by ldevoude          #+#    #+#             */
/*   Updated: 2025/08/30 15:39:12 by ldevoude         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static int	fill_node_i(t_settings *settings, t_philo *philo, t_forks *forks,
		long i)
{
	philo[i].id = i + 1;
	philo[i].meals_eaten = 0;
